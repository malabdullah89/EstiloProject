...
import { View, Text, StatusBar, TouchableOpacity, StyleSheet, Dimensions, KeyboardAvoidingView,AsyncStorage, ScrollView ,Image} from 'react-native';
    ...
    renderHeader() {
        return (
           <View style={[this.props.Language=='AR'? styles.row:styles.rowReversed, styles.shadow, { width: width, height: '10%', alignItems: 'center', backgroundColor: '#383B43', paddingHorizontal: 18 }]} >
             ...
             <Text style={{ flex:1,textAlign:'center',color: '#fff', fontSize: 17,fontFamily:'nexa_bold',}}>{this.props.Language=='AR'?'أضافة عنوان جديد':'Add New Address'}</Text>
            ...
            <View style={styles.container} >
                ...
                <KeyboardAvoidingView
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 12, paddingBottom: 18 }} >
                        ...
                        {/* <View style={[this.props.Language=='AR'?styles.row:styles.rowReversed, { justifyContent: 'center', alignItems: 'center',borderRadius:60,borderColor:'#707070',borderWidth:2,marginTop: 15 }]} >
                      ...
                      <View style={[styles.row, { justifyContent: 'center', alignItems: 'center' ,borderRadius:60,borderColor:'#707070',borderWidth:2,marginTop:30,}]} >
                        ...
                        <View style={[styles.row, { justifyContent: 'center', alignItems: 'center', marginTop: height*0.1 }]}>
                            <TouchableOpacity onPress={() => {this.SendLocation() }} style={[styles.Button, styles.shadow, { backgroundColor: '#383B43' }]} >
