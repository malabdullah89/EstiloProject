        ...
        return(
         <View  >
            ...
            : null
                   ...
                   {width < 1250 ? <MobileHeader title='PRIVACY POLICY' handlerDrawer={this.viewDrawer} /> : 
                   <Header flagIcon={true} title='Privacy Policy' iconName='briefcase' handlerLogin={this.viewLogin} /> 
                   }
                   {
                      this.state.drawer ? 
               ...
               {width < 1250 ? null : 
                  <View style={{flex:1, marginBottom: 30 , marginLeft: 50}}>
                     <View style={{flex:1.5 , backgroundColor: '#FFCF01', paddingVertical: 20 , alignItems: 'center', justifyContent: 'center'}}>
                        <Icon name='lock' size={180} color='#020202' />
                     </View>
...
export default connect(mapStateToProps, { SetLoading})(PrivacyPolicy)
