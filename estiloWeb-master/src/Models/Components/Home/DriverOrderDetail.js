...
import { View, Text, TouchableOpacity, Dimensions, StyleSheet, ImageBackground,StatusBar, Image, ScrollView,FlatList } from 'react-native';
...
class DriverOrderDetail extends Component{
  ...
  renderStores(item , index){
   ...
   render(){
      const titleAr1='هل أنت متأكد أنك تريد البدء في تسليم هذا الطلب؟'
      const titleAr2='هل تريد بالتأكيد وضع علامة على هذا الطلب على أنه تم تسليمه؟'
      const titleEn1 = 'Are you sure you want to start delivering this order ?'
      const titleEn2 ='Are you sure you want to mark this order as Delivered ?'
        return(
