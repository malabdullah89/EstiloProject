...
class ReturnPolicy extends Component{
   ...
   viewDrawer(){
    ...
    render(){
       const imgSize = width < 1250 ? 50 : 120; 
        return(
         <View  >
            ...
            : null
                   ...
                   {width < 1250 ? <MobileHeader title='RETURN POLICY' handlerDrawer={this.viewDrawer} /> : 
                   <Header flagIcon={true} title='Return Policy' iconName='briefcase' handlerLogin={this.viewLogin}/> 
                   }
                   {
                      this.state.drawer ? 
               ...
               <View style={{flex:5,flexDirection: 'row',}}>
                  {width < 1250 ? null :
                  <View style={{flex:1, marginBottom: 30 , marginLeft: 50}}>
                  <View style={{flex:1.5 , backgroundColor: '#FFCF01', paddingVertical: 20 , alignItems: 'center', justifyContent: 'center'}}>
                     <Image source={require('./../../../image/return2.png')} style={{ width:180,height:180 ,margin:2}} resizeMode='contain' />
                  </View>
                  ...
                  <View style={{flex: 4}}>
                     ...
                     <View style={[ width < 1250 ? {justifyContent: 'center'}:{ justifyContent: 'left', marginLeft: 50 } , {width:'100%',alignItems:'center',flexDirection:'row',marginTop:15}]}>
                     <Image source={require('./../../../image/return1.png')} style={{ width:imgSize,height:imgSize ,margin:6}} resizeMode='contain' />
                     <Image source={require('./../../../image/arrow.png')} style={{ width:imgSize,height:imgSize-30 ,margin:6}} resizeMode='contain' />
                     <Image source={require('./../../../image/return2.png')} style={{ width:imgSize,height:imgSize ,margin:6}} resizeMode='contain' />
                     <Image source={require('./../../../image/arrow.png')} style={{ width:imgSize,height:imgSize-30 ,margin:6}} resizeMode='contain' />
                     <Image source={require('./../../../image/return3.png')} style={{ width:imgSize,height:imgSize ,margin:6}} resizeMode='contain' />
                     </View>  
